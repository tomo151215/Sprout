...
- [🌱 Sprout Game Engine](#-sprout-game-engine)
    - [Lightweight Java 2D Game Engine](#lightweight-java-2d-game-engine)
  - [Sproutとは](#sproutとは)
  - [主な機能](#主な機能)
- [目次](#目次)
- [プロジェクト構成](#プロジェクト構成)
...
- [1. GameApplicationを作る](#1-gameapplicationを作る)
  - [`GameApplication` チートシート](#gameapplication-チートシート)
  - [`GameSettings` Builder](#gamesettings-builder)
  - [`RendererConfig` Builder](#rendererconfig-builder)
- [2. GameObjectを作る](#2-gameobjectを作る)
  - [`GameObject` チートシート](#gameobject-チートシート)
- [3. 画像を読み込んでSpriteを描画する](#3-画像を読み込んでspriteを描画する)
  - [画像を読み込む](#画像を読み込む)
  - [`ImageLoader` チートシート](#imageloader-チートシート)
  - [Spriteを操作する](#spriteを操作する)
  - [`Sprite` チートシート](#sprite-チートシート)
    - [リサイズ方法の使い分け](#リサイズ方法の使い分け)
  - [GameObjectでSpriteを描画する](#gameobjectでspriteを描画する)
- [4. キーボード入力を追加する](#4-キーボード入力を追加する)
  - [キーマッピング チートシート](#キーマッピング-チートシート)
...
- [6. マウス入力を使う](#6-マウス入力を使う)
  ...
  - [マウスボタン](#マウスボタン)
  - [マウスホイール](#マウスホイール)
  - [InputContextの有効・無効](#inputcontextの有効無効)
- [7. カメラを追加する](#7-カメラを追加する)
  - [`Camera2D` チートシート](#camera2d-チートシート)
- [8. Look Aheadを追加する](#8-look-aheadを追加する)
  - [`CameraLookAhead` チートシート](#cameralookahead-チートシート)
- [9. Camera Boundsを追加する](#9-camera-boundsを追加する)
  - [`CameraBounds` チートシート](#camerabounds-チートシート)
- [10. Dead Zoneを追加する](#10-dead-zoneを追加する)
  - [`CameraDeadZone` チートシート](#cameradeadzone-チートシート)
  - [Cameraシステム全体](#cameraシステム全体)
  - [`CameraController` チートシート](#cameracontroller-チートシート)
  - [`CameraFollow` チートシート](#camerafollow-チートシート)
- [11. Audioを使う](#11-audioを使う)
  - [SEを再生する](#seを再生する)
  - [BGMを再生する](#bgmを再生する)
  - [`AudioManager` チートシート](#audiomanager-チートシート)
- [12. Sceneを使う](#12-sceneを使う)
  - [Sceneを作る](#sceneを作る)
  - [`Scene` チートシート](#scene-チートシート)
  - [`SceneManager` チートシート](#scenemanager-チートシート)
- [13. 完成したミニゲーム](#13-完成したミニゲーム)
  - [ワールドとCamera](#ワールドとcamera)
  - [Action.java](#actionjava)
  - [SpriteObject.java](#spriteobjectjava)
  - [WorldObject.java](#worldobjectjava)
  - [SampleGame.java](#samplegamejava)
  - [Main.java](#mainjava)
  - [このミニゲームで使用している機能](#このミニゲームで使用している機能)
